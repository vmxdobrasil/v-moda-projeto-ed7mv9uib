  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-background">
      ...
      {isAuthenticated && !isEmbed && (
        <Link
          to="/beneficios"
          className="fixed bottom-24 right-6 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground p-3 rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all z-50 flex items-center gap-2 animate-fade-in-up"
        >
