    ...
    <div className="space-y-6 animate-fade-in-up p-2">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Bem-vindo(a) ao portal da V MODA. Descubra tendências e coleções.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium font-display">Novas Coleções</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium font-display">Meus Favoritos</CardTitle>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium font-display">Marcas Recomendadas</CardTitle>
